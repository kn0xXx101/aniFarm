  ...
  return (
    <View style={{ height }}>
      <Svg viewBox="0 0 100 100" preserveAspectRatio="none" width="100%" height="100%">
        ...
        <Line x1="0" y1="25" x2="100" y2="25" stroke="hsl(150 20% 88%)" strokeWidth={0.2} />
        <Line x1="0" y1="50" x2="100" y2="50" stroke="hsl(150 20% 88%)" strokeWidth={0.2} />
        <Line x1="0" y1="75" x2="100" y2="75" stroke="hsl(150 20% 88%)" strokeWidth={0.2} />
      ...
      <View className="flex-row justify-between px-1 mt-1">
        {ticks.map((t) => (
          <Text key={t.idx} variant="muted" size="xs">
            {t.label}
          </Text>
        ))}
      </View>
