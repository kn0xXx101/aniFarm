                  ...
                  <SafeAreaView edges={['top']}>
                    <View className="px-5 pt-2 flex-row items-center justify-between">
                      <View className="flex-row items-center gap-2">
                        <View className="size-9 rounded-2xl bg-white/25 items-center justify-center">
                      ...
                      <Pressable
                        onPress={close}
                        className="size-10 rounded-full bg-white/20 items-center justify-center"
                        accessibilityLabel="Close menu"
                      >
                    ...
                    <View className="px-5 mt-6 flex-row items-center gap-3">
                      <View className="size-14 rounded-full bg-white items-center justify-center">
                        <Text className="text-2xl font-bold" style={{ color: '#FF6A3D' }}>
              ...
              <View className="px-3 pt-4 flex-1">
                {items.map((it) => {
                  ...
                  return (
                    ...
                    >
                      <View className="size-10 rounded-xl bg-secondary items-center justify-center">
                        <Icon size={18} color="hsl(18 95% 58%)" />
                      </View>
                      <Text className="flex-1 font-semibold">{it.label}</Text>
                      {it.badge && it.badge > 0 ? (
                        <View className="bg-destructive rounded-full min-w-[22px] h-[22px] px-1.5 items-center justify-center">
                ...
                >
                  <View className="size-10 rounded-xl bg-secondary items-center justify-center">
                    <SettingsIcon size={18} color="hsl(18 95% 58%)" />
                  </View>
                ...
                >
                  <View className="size-10 rounded-xl bg-destructive/10 items-center justify-center">
                    <LogOut size={18} color="hsl(348 90% 56%)" />
                  </View>
